...
for load in loads:
    g35 = get_log2_peptide_means(df, "3p5", load, "ACN")
    g55 = get_log2_peptide_means(df, "5p5", load, "ACN")
...
ax.set_title("Surface Type (ACN)", fontsize=13)
...
plt.tight_layout()
plt.savefig("SurfaceType_3.5_vs_5.5_ACN.png", bbox_inches='tight')
plt.show()
